                            ...
                            onClick={(evt) => {
                                ...
                                checkInSession(sessionId, genesetName).then((response) => {
                                    if (response) {
                                        ...
                                        addToSessionSets(genesetGenes.toString().replaceAll("'", '').split(','), sessionId, genesetName, '', [], true, null)
                                ...
                                onClick={(evt) => {
                                    ...
                                    checkInSession(sessionId, genesetName).then((response) => {
                                        if (response) {
                                            ...
                                            addToSessionSets(params.row.overlap.toString().replaceAll("'", '').split(','), sessionId, genesetName, '', [], true, null)
                                            .then((result) => { setStatus({ success: true }) }).catch((err) => setStatus({ error: { selected: true, message: "Error in adding gene set!" } }))
                                        }
                                    })
                                }}
